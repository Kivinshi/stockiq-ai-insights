...
//              className="mt-4 inline-flex h-10 items-center px-4 rounded-lg bg-gradient-primary text-primary-foreground text-sm font-medium shadow-elegant hover:opacity-90 transition"
//            >
//              Update password
//            </button>
//          </div>
...
function Profile() {
  ...
  async function updatePassword() {
    ...
    try {
      await apiPostAuth<{ message: string }, { currentPassword: string; newPassword: string }>(
          ...
          <div className="mt-6 pt-6 border-t border-border">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              ...
              <PasswordInput
                ...
                onChange={(value) => setPasswordForm((f) => ({ ...f, newPassword: value }))}
              />
